...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('deleted_orders', function (Blueprint $table) {
            ...
            $table->integer('is_shipped')->default(0)->nullable();
            ...
            $table->boolean('tuffnells')->default(0)->nullable();
            $table->char('order_number_part_0', 1)->nullable()->comment('R');
            $table->char('order_number_part_1', 4)->nullable()->comment('REQUEST_SOURCE_BEDS = \'B\'; REQUEST_SOURCE_EBAY = \'E\'; REQUEST_SOURCE_OTHER = \'T\'; REQUEST_SOURCE_STAFF = \'S\';');
            $table->char('order_number_part_2', 13)->nullable()->comment('uniqid()');
            $table->char('order_number_part_3', 3)->nullable()->comment('mt_rand(1, 999)');
            $table->char('order_number_part_4', 4)->nullable()->comment('EXTENSION_BASE = \'P\'; EXTENSION_EXCHANGE = \'E\'; EXTENSION_SPLIT_ORDER = \'P\';');
            $table->string('sales_record', 10)->default('0')->nullable();
            $table->boolean('priority')->default(0)->nullable();
            $table->boolean('manual_order')->default(0)->nullable();
            $table->integer('delivery_issue')->default(0)->nullable();
        });
    }
